#!/usr/bin/env python
"""
FCNT Matlab execution script

Simple script to call the MATLAB-program FCNT by Wang et al. with 
all the samples of the video tracking benchmark by Wu et al.

My fork of the FCNT-Program can be found at 
